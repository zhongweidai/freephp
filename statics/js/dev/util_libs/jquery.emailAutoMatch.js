 ...
 * $Id: jquery.emailAutoMatch.js 12158 2012-06-19 06:53:36Z liusanbian $
 */
...
;(function ($, window, document, undefined) {
	...
	var list_wrapper = $('<div style="position:absolute;background:#fff;" class="mail_down" id="J_email_list"></div>');
				...
				if (e.keyCode === 38) {
					...
					if (li_arr.length) {
						...
						list_wrapper.css({
							...
							top : element.offset().top + element.innerHeight() +2,
