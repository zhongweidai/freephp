...
;(function ( $, window, undefined ) {
			...
			<div class="edit_menu" style="display:none;">\
				<div class="edit_menu_video">\
					...
					<div class="edit_menu_cont">\
						<dl class="cc">\
							<dt>地址：</dt>\
							<dd><input type="text" class="input length_5" id="J_input_net_video"></dd>\
						</dl>\
						<dl class="cc">\
							<dt>尺寸：</dt>\
					...
					<div class="edit_menu_bot">\
						<button type="button" class="edit_menu_btn">提交</button><button class="edit_btn_cancel" type="button">取消</button>\
					</div>\
				</div>\
			</div>');
	...
	WindEditor.plugin(pluginName,function() {
		...
		var editorDoc = _self.editorDoc = _self.iframe[0].contentWindow.document,
			...
			var plugin_icon = $('<div class="wind_icon"><span class="'+ pluginName +'" title="插入视频"></span></div>').appendTo( big_icon_box );
