 ...
 * @Include		: head.js
 * $Id: core.js 12351 2012-06-20 11:08:25Z hao.lin $			:
 */
...
(function(win){
	var root = win.GV.JS_ROOT || location.origin + '/js/dev/', //在core.js加载之前定义GV.JS_ROOT
		...
		alias = {
			...
			'like'                   : 'ui_libs/like/like',
			
			//jquery util plugs
			'jquery.bgiframe'		: 'util_libs/jquery.bgiframe',
			'jquery.form'			: 'util_libs/jquery.form',
			'jquery.hotkeys'		: 'util_libs/jquery.hotkeys',
			'jquery.hoverdelay'		: 'util_libs/jquery.hoverdelay',
			'jquery.validate'		: 'util_libs/jquery.validate',
			'jquery.timeago'		: 'util_libs/jquery.timeago',
			'jquery.tablesorter'	: 'util_libs/jquery.tablesorter',
			'jquery.requestFullScreen' : 'util_libs/jquery.requestFullScreen',
			'jquery.dragUpload'		: 'util_libs/jquery.dragUpload',
			'jquery.draggable'		: 'util_libs/jquery.draggable',
			'jquery.lazyload'		: 'util_libs/jquery.lazyload',
			'jquery.uploadPreview'	: 'util_libs/jquery.uploadPreview',
			'jquery.emailAutoMatch'	: 'util_libs/jquery.emailAutoMatch',
			'jquery.textCopy'		: 'util_libs/textCopy/jquery.textCopy',
			'jquery.dateSelect'		: 'util_libs/jquery.dateSelect',
			'jquery.scrollFixed'	: 'util_libs/jquery.scrollFixed',
			'jquery.lazySlide'		: 'util_libs/jquery.lazySlide',
			'jquery.slidePlayer'	: 'util_libs/jquery.slidePlayer',
            'jquery.rangeInsert'    : 'util_libs/jquery.rangeInsert',
            'jquery.gallerySlide'   : 'util_libs/jquery.gallerySlide',
             'jquery.listTable'   : 'util_libs/jquery.listTable',
	...
	//use alias loader the script file
	Wind.use = function() {
