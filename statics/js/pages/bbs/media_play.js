 ...
 */
 $(function() {
 	var jPlay_js = window.GV.JS_ROOT + '/util_libs/jquery.jPlayer/jquery.jplayer.js';
	var jPlay_skin_css = window.GV.JS_ROOT + '/util_libs/jquery.jPlayer/skin/blue.monday/jplayer.blue.monday.css';
		...
		function parseAudios() {
			audios.each(function(i) {
				...
				$(this).jPlayer({
					...
					swfPath: window.GV.JS_ROOT + '/util_libs/jquery.jPlayer',
					supplied: "mp3",
					wmode: "window",
