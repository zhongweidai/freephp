...
<!--用户权限编辑添加: 用户编辑弹窗-->
<form id="J_auth_form" action="<?php echo U('admin/auth/edit');?>" method="post" class="J_ajaxForm"  data-role="edit">
<input id="J_userId" type="hidden" value="<?php echo $admin['ID'];?>" name="id" />
<div style="width:550px;background:#fff;">
	<div class="pop_cont pop_table">
		<div class="mb15">
			<table width="100%" style="table-layout:fixed;">
				...
				<td>
					...
					<input name="info[USERNAME]" readonly value="<?php echo $admin['USERNAME'];?>" type="text" class="input input_hd" /> 作为后台登录的唯一账号
				</td>
				</tr>
				<tr>
				...
				<td>
				 ...
				 <tr>
					...
					<td><span class="must_red">*</span>
						<input type="text" name="info[REALNAME]" class="input input_hd length_3" value="<?php echo $admin['REALNAME'];?>"> 
					</td>
				</tr>
				<tr>
				...
				<td>
					<span class="must_red">*</span>
					<input type="text" name="info[EMAIL]" class="input input_hd length_3" value="<?php echo $admin['EMAIL'];?>" />
				</td>
				</tr>
			</table>
		</div>
		<div class="cc shift">
			...
			<div class="fl">
				...
				<?php $n=1;if(is_array($admin_role)) foreach($admin_role AS $r) { ?>
					<option value="<?php echo $r;?>"><?php echo $roles[$r]['NAME'];?></option>
				<?php $n++;}unset($n); ?>
				</select>
			</div>
		</div>
	</div>
	<div class="pop_bottom"><button id="J_auth_sub" class="btn btn_submit" type="submit">提交</button><div id="J_submit_tips"></div></div>
</div>
