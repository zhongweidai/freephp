...
<form class="J_ajaxForm" data-role="list" action="<?php echo U('admin/role/add');?>" method="post">
...
<div class="table_full">
	<table width="100%" class="J_check_wrap">
		...
		<th>状态</th>
			<td>
				<label><input name="status" type="checkbox" checked}></label>选中代表开启当前角色
			</td>
			<td><div class="fun_tips"></div></td>
		</tr>
	</table>
...
var ROLE_LIST_CONFIG = <?php echo $role_table;?>, //已有角色的权限集合
	ROLE_AUTH_CONFIG = <?php echo json_encode(array());?>; //当前角色的已有权限集合
