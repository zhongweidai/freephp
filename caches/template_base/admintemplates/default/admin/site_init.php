...
<div class="nav">
	<ul class="cc">
		<li class="current"><a href="<?php echo U('admin/site/init');?>"><?php echo L('site_management');?></a></li>
	</ul>
	
</div>
<div class="fr">
		<form class="J_custom_ajaxForm" method="post" action="">
			<button class="btn btn_submit J_ajax_submit_btn fr" data-url="<?php echo U('admin/site/cache');?>" data-form="J_custom_ajaxForm">刷新站点缓存</button>
...
<form method="post" class="J_ajaxForm" action="<?php echo U('admin/site/opera',array('id'=>$id));?>" data-role="list">
...
<div class="table_list">
	<table width="100%" id="J_table_list" style="table-layout:fixed;">
		...
		<thead>
			<tr>
				<td></td>
				<td>[<?php echo L('sort');?>] <?php echo L('site_name');?></td>
				<td><?php echo L('site_title');?></td>
				<td><?php echo L('site_code');?></td>
				<td><?php echo L('status');?></td>
				<td><?php echo L('site_management');?></td>
			</tr>
		</thead>
	<?php
	...
	?>
		...
		<tr class="bgA">
			...
			<td>
				...
				<a style="display:none" href="<?php echo U('admin/site/add',array('parentid'=>$value['ID']));?>" class="link_add J_addChild add_nav" data-id="<?php echo $value['CODE'];?>" data-html="tbody" data-type="nav_2" data-leve="1" ><?php echo L('add_next_site');?></a>
			</td>
			<td>
				<input name="data[<?php echo $value['ID'];?>][TITLE]" type="text" class="input length_3 mr5" value="<?php echo $value['TITLE'];?>">	
			</td>
			<td>
				<input name="data[<?php echo $value['ID'];?>][CODE]" type="text" class="input length_1" value="<?php echo $value['CODE'];?>">
			</td>
			<td class="tac"><input name="data[<?php echo $value['ID'];?>][STATUS]" type="checkbox" value="1" <?php echo $checked;?>></td>
			<td>
				<a href="<?php echo U('admin/site/edit',array('id'=>$value['ID']));?>" class="mr10 J_dialog" title="<?php echo L('edit');?>">[<?php echo L('edit');?>]</a>
				<a href="<?php echo U('admin/site/delete',array('id'=>$value['ID']));?>" class="mr10 J_ajax_del">[<?php echo L('delete');?>]</a>
				<?php
					if($count>0){
				?>
		...
		?>
			<tr>
				...
				<td>
					<input name="data[<?php echo $childValue['ID'];?>][TITLE]" type="text" class="input length_3 mr5" value="<?php echo $childValue['TITLE'];?>">
				</td>
				<td>
					<input name="data[<?php echo $childValue['ID'];?>][CODE]" type="text" class="input length_1" value="<?php echo $childValue['CODE'];?>">
				</td>
				<td class="tac"><input name="data[<?php echo $childValue['ID'];?>][STATUS]" type="checkbox" value="1" <?php echo $checked;?>></td>
				<td>
					<a href="<?php echo U('admin/site/edit',array('id'=>$childValue['ID']));?>" class="mr10 J_dialog" title="导航编辑">[编辑]</a><a href="<?php echo U('admin/site/delete',array('id'=>$childValue['ID']));?>" class="mr10 J_ajax_del">[删除]</a>
				</td>
			</tr>
		<?php }?>
		</tbody>
	...
	<table width="100%">
		<tr class="ct"><td colspan="5" style="padding-left:38px;"><a data-type="nav_1" data-html="tbody" href="" id="J_add_root" class="link_add"><?php echo L('site_add');?></a></td></tr>
	</table>
</div>
<div class="btn_wrap">
