		...
		switch (gettype($str)) {
			case 'string':
				if ($ifMb && function_exists('mb_convert_encoding'))
					...
					Free::loadClass('FreeGeneralConverter',PC_PATH . 'libs/convert',0);	
					/* @var $converter FreeGeneralConverter */
					$converter = Free::loadClass('IFreeConverter',PC_PATH . 'libs/convert',1);
