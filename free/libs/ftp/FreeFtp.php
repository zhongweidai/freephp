 ...
 * <code>
 * 
 * $ftp = new FreeFtp(array('server' => '192.168.1.10', 'port' => '21', ‘user' => 'test', 'pwd' => '123456'));
 * print_r($ftp->fileList());
 * </code>
 *
 */
class FreeFtp extends AbstractFreeFtp {
	...
	public function upload($sourceFile, $desFile, $mode = 'A') {
		...
		$desFile = $this->rootPath . FreeSecurity::escapePath($desFile);
	...
	/* (non-PHPdoc)
	 * @see AbstractFreeFtp::initConfig()
	 */
